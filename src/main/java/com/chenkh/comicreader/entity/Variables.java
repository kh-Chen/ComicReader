...
public class Variables {
    ...
    public static final String TEMPLATE_BOOKS = """
            <html>
                <head>
                    <title>目录</title>
    ...
    public static final String TEMPLATE_BOOK_LINK = """
                    <div class="condiv" >
                        <div style="width: calc(100% - 120px);">
                            <a href="{url}">
                                ...
                                <div>已读至 {readAt} 章，共 {total} 章</div>
                            </a>
                        </div>
            ...
            """;
    public static final String TEMPLATE_BOOK_CHAPTERS = """
            <html>
                <head>
                    <title>{title}</title>
                    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    public static final String TEMPLATE_CHAPTER_LINK = """
                    <div class="condiv" >
                        <a href="{url}">
            ...
            """;
    public static final String TEMPLATE_CHAPTER_IMGS = """
            <html>
                <head>
                    <title>{chapter}</title>
                    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
                ...
                <body>
                    <div class="read-container">
                        ...
                        <div class="rd-article-wr">
                            <!-- <img src="../../images/book/ch/001.jpg"  /> -->
                            <img_here />
                        </div>
